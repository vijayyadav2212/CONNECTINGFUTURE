        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100">
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 text-lg mb-4">Settings section coming soon...</p>
              <p className="text-slate-500">Manage your profile, preferences, and account settings!</p>
            </div>
          </div>
        </div>
      </div>
