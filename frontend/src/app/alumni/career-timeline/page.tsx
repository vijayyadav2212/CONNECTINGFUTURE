    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <a href="/api/auth/login" className="px-4 py-2 bg-teal-500 text-white rounded hover:bg-teal-950">
            Login
          </a>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-8">
              <Link href="/alumni/dashboard" className="flex items-center text-teal-600">
                ...
                <div className="bg-teal-50 p-4 rounded-lg">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-teal-600 font-medium">ABC Engineering College</p>
                      <p className="text-sm text-gray-500">2012 - 2016 • CGPA: 8.5/10</p>
                    </div>
                    <Badge className="bg-teal-100 text-teal-800">Education</Badge>
                  </div>
                  <p className="text-gray-600 mb-3">
