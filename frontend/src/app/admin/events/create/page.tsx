    ...
    <AdminNavigation>
      <div className="max-w-3xl mx-auto space-y-5">
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-100 p-5 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2"><Calendar className="w-6 h-6 text-green-600" />Create New Event</h1>
            <p className="text-gray-500 text-sm mt-0.5">Host a new event for alumni and students</p>
          </div>
        </div>
        ...
        {showSuccess && (
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3">
            ...
            <div><p className="text-sm font-bold text-green-800">Event created successfully!</p><p className="text-xs text-green-600">Redirecting…</p></div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {formData.image && <span className="flex items-center gap-1 text-xs font-bold text-green-600"><CheckCircle className="w-3.5 h-3.5" />Selected</span>}
                </div>
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <button type="submit" className="flex items-center gap-2 px-6 py-2.5 text-sm font-bold rounded-xl bg-green-600 text-white hover:bg-green-700 transition-colors shadow-sm"><Save className="w-4 h-4" />Create Event</button>
          </div>
        </form>
      </div>
    </AdminNavigation>
