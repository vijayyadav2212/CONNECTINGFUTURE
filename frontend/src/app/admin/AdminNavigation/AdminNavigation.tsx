...
export default function AdminNavigation({ children }: AdminNavigationProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      {/* Navigation Sidebar */}
      <aside className="hidden lg:flex fixed left-0 top-0 z-40 w-64 h-screen bg-white shadow-xl border-r border-gray-200 flex-col">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          />
          <div className="absolute left-0 top-0 h-full w-[86%] max-w-sm bg-white shadow-2xl border-r border-gray-200 overflow-y-auto">
      ...
      <main className="lg:ml-64 min-h-screen">
        <div className="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg sm:text-2xl font-bold text-gray-900">Admin Dashboard</h2>
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Manage and monitor your platform</p>
            </div>
